...
Semantic HTML helps to describe the element's functionality to the browser.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
Block display elements start on a new line, inline does not.
...
Git allows a team of people to work together, all using the same files. And it helps the team cope with the confusion that tends to happen when multiple people are editing the same files. Git is also a version control system that allows you to restore previous versions of your work.
